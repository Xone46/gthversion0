<template>
  <div class="container">
    <div id="nav">
      <router-link to="/equipements" v-if="this.$route.path === '/equipements'">
        Les Equipements
      </router-link>
    </div>
    <input
      class="form-control"
      v-model="filter"
      v-on:keyup.prevent="searchCompte"
      type="text"
      placeholder="Search.."
    />
    <br />
